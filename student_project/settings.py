...
# Note: In a real project, this key should be kept secret.
...
# The default middleware classes were missing. The admin interface
# relies on these for handling sessions, user authentication, and messages.
MIDDLEWARE = [
